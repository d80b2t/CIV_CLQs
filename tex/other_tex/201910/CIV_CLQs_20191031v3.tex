...
%and $t_{\rm dyn} =\sqrt{ R^{3}/GM}$ means e.g $t_{\rm dyn} \sim 6 G^{3} M^{3} / GM c^{2} \sim 6G^{2} M^{2} / c^{2}.
...
%\begin{equation}
%t_{\rm lt} = R_{s} / c = 32015 {\rm secs}$
%\end{equation}
%and a {\it dynamical timescale}, $t_{\rm dyn}$
%\begin{equation}
%$t_{\rm dyn}  =  sqrt{ R_{s}^{3}/G M}
% \end{equation}
%also (!!!!!) of $t_{\rm dyn}  =  \sqrt{ R_{s}^{3}/G M}$ = 32015 seconds. 
