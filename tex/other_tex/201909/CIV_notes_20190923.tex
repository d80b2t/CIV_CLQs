...
\noindent {\tt $alpha_{\civ}$} = power law continuum slope ($f_{\lambda}\propto \lambda^{\alpha}$) measured from the BOSS spectrum on either side of \civ .
\noindent {\tt $alpha_{\rm allc}$} = power law continuum slope ($f_{\lambda}\propto \lambda^{\alpha}$) between 1350 \AA\ and 2200 \AA\ in the flux corrected BOSS spectrum, listed only for quasars wit $z_{\rm e} \le 3.4$ (with 1$\sigma$ uncertainty). 
...
\noindent {\tt FWHM} = \civ\ FWHM (km/s) from the line profile fit (with 1$\sigma$ uncertainty). 
