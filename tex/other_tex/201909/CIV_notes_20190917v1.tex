...
\citep{Kramida2018}. 
% A., Ralchenko, Yu., Reader, J., and NIST ASD Team (2018). NIST Atomic Spectra Database (ver. 5.6.1), [Online]. Available: https://physics.nist.gov/asd [2019, September 17]. National Institute of Standards and Technology, Gaithersburg, MD. DOI: https://doi.org/10.18434/T4W30F

%The singly ionized hydrogen atom H+ is referred to as HII, doubly ionized oxygen O++ is called OIII, etc.
%11.3 eV is the energy needed for C I to get rid of one electron, and become singly-ionised C II”
...
used the subset (roughly half) of this sample containing the \civ 1549\AA 
...
\citet{Coatman2016} show that %%Black hole masses are crucial to understanding the physics of the connection between quasars and their host galaxies and measuring cosmic black hole-growth. 
