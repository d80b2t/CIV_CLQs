...
$\Omega_{\rm M} = 0.27$, and $h = 0.71$.
% in order to be consistent with \citet{Hamann2017}. As a guide this cosmology has a $z=2.000$ comoving radial distance of 5244.3 Mpc, a $\sim$1.25\% difference compared to 5179.0 Mpc from $\Omega_{\Lambda} = 0.70$, $\Omega_{\rm M} = 0.30$, and $h = 0.70$ that is used in \citet{Shen2011}.
...
32-month sampling gap. [{\it DANIEL to write something on FIRST
non-detections; possibly check the X-rays too?}]
...
Emission line measurements from the QSFit routine of
\citet{Calderone2017} are presented in Table~\ref{tab:LineMeasurements}. 
and fits for the \civ\ line are given in~\ref{fig:CIV_LineFits}.
...
Figure~\ref{fig:CIV_Baldwin}. This figure, reproduces that of
Figure~15 from \citet{Calderone2017}, but where we know
...
selection requires large-amplitude ($∣\Delta g∣ > 1 mag, ∣\Delta r∣ >
0.5 mag$) variability over any of the available time baselines probed
by the SDSS and Pan-STARRS1 surveys.  For our adopted signal-to-noise
ratio threshold on variability of broad H$\beta$ emission, they find
17 new CLQs (which is $\sim20$ of the observerd sample). These
candidates are at lower Eddington ratio relative to the overall quasar
population, while the CLQ fraction increases from 10\% to roughly
half, as the continuum flux ratio between repeat spectra at 3420 \AA\
(rest-frame) increases from 1.5 to 6.

\citet{Homan2019} investigate the responsiveness of the \mgii broad
emission line doublet in AGN on timescales of several years.  This
study is based on a the same extremely variable quasar sample as was
used for \citet{MacLeod2019}.  By again focussing on quasars that show
large changes in their optical light-curves, \citet{Homan2019} find
that \mgii clearly does respond to the continuum.  However, a key
finding from \citet{Homan2019} is that the degree of responsivity
varies strikingly from one object to another.  There are cases of
\mgii changing by as much as the continuum, more than the continuum,
or very little at all.  In the majority (72\%) of this highly variable
sample, the behaviour of \mgii corresponds with that of H$\beta$.
However, there are also examples of \mgii showing variation, but
H$\beta$ does not, and vice versa.
...
spectra \citet[e.g.][]{HamannFerland1999}, and 
...
\citet{Ge2016} Broad emission lines is a prominent property of Type 1 quasars. 


\begin{figure*}
  \centering
  \includegraphics[width=14.5cm, trim=0.2cm 0.2cm 0.0cm 0.2cm, clip]
  {figures/MJD_vs_Eddington_20191115.png}
  \vspace{-12pt}
