...
collisionally excited, including \ciii, C\,{\sc iv} and N\,{\sc
...
the uncertainties on the model parameters.  Section 2.8.3 and Appendix
B4 of \citet{Calderone2017} gives further details and compares the
Fisher matrix and Monte Carlo resampling uncertainties and
distributions.}
...
These are all within $\approx 0.1 - 0.6$ dex of the values we
calculated for these epochs.
