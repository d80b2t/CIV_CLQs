...
##  Spectra
infile   = 'DBSP_J2228p2201_b_56893.dat'
DBSP_b  = ascii.read(path+infile)
infile   = 'DBSP_J2228p2201_r_56893.dat'
...
ax2.plot(   sdss_wavelength/(1+redshift), sdss_flux,         '-b', lw=linewidth/4.0, label='SDSS MJD 56189')
ax2.plot(   boss_wavelength/(1+redshift), boss_flux,         '-r', lw=linewidth/4.0, label='BOSS MJD 56960')
...
plt.savefig('J2228+2201_temp.png', format='png')
plt.close(fig)
