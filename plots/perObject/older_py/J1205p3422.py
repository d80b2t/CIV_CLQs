...
ax3.set_xlabel(r'Restframe wavelength', fontsize=fontsize)
...
ax3.tick_params(axis='both', which='major', labelsize=labelsize/2.,
               #top=True, right=True,
               direction='in', length=ticklength,   width=tickwidth)
#ax3.tick_params(axis='both', which='minor', labelsize=labelsize/4.,  top=True, right=True, direction='in', length=ticklength/2, width=tickwidth)
...
plt.figure(1).axes[0].get_xaxis().get_label().set_fontname("Times New Roman")
plt.figure(1).axes[0].get_xaxis().get_label().set_fontsize(24.000000)
plt.figure(1).axes[0].get_xaxis().get_label().set_weight("normal")
plt.figure(1).axes[1].set_position([0.460541, 0.560924, 0.499459, 0.399076])
plt.figure(1).axes[1].xaxis.labelpad = 262.160000
plt.figure(1).axes[1].yaxis.labelpad = 1.040000
plt.figure(1).axes[1].get_xaxis().get_label().set_fontname("Lucida Grande")
plt.figure(1).axes[1].get_xaxis().get_label().set_fontsize(24.000000)
plt.figure(1).axes[1].get_yaxis().get_label().set_fontname("Lucida Grande")
plt.figure(1).axes[1].get_yaxis().get_label().set_fontsize(28.000000)
plt.figure(1).axes[2].set_position([0.460541, 0.160000, 0.138919, 0.347826])
plt.figure(1).axes[2].get_xaxis().get_label().set_text("")
plt.figure(1).axes[3].set_position([0.641311, 0.160000, 0.138919, 0.347826])
plt.figure(1).axes[4].set_position([0.821081, 0.160000, 0.138919, 0.347826])
