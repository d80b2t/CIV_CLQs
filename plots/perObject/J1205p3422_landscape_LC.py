...
## Quasar Lable Name
#plt.text(54800, 16.8, r'{\bf J1205+3422}, $z$=2.068',  fontsize=fontsize*1.2)
plt.text(54700, 16.8, r'{\bf J1205+3422}',  fontsize=fontsize*1.2)

plt.savefig('J1205+3422_landscape_LC_temp.png', format='png')
plt.close(fig)
